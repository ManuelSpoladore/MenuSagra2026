      ...
      <div className="mx-auto max-w-screen-xl px-4 pt-7 pb-8 sm:px-6 lg:px-8">
        ...
        <div className=" flex justify-center items-center md:mt-5border-gray-800">
          <ul className="mt-8 flex justify-center gap-6 sm:mt-0 ">
            <li>
              <a
                href="https://www.facebook.com/comitatoligugnana/?locale=it_IT"
                rel="noreferrer"
                target="_blank"
            ...
            <li>
              <a
                href="https://www.instagram.com/com.festeggiamenti.ligugnana/"
                rel="noreferrer"
                target="_blank"
                className="text-gray-700 transition hover:opacity-75 dark:text-gray-200"
              >
        ...
        <p className="text-white text-center pt-5">Sito creato da Manuel Spoladore</p>
      </div>
    </footer>
  );
}
